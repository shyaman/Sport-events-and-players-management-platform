    ...
    <div>
        ...
        <style jsx global>{`
           * { padding: 0; margin: 0; outline: 0; }
           ...
           #header .shell {width: 1018px; background: url(static/header.jpg) no-repeat 10px 0;height: 84px;}
           
           h1#logo {padding-left: 250px; float: left; padding-top: 21px;}
           h1#logo a {display: block; background: url(static/logo.gif) no-repeat 0 0; width: 299px; height: 39px;}
           ...
           #heading {height: 340px; background: url(static/heading.jpg) repeat-x 0 0;}
           #heading .shell {width: 983px; position: relative;}
           #heading-cnt {background: url(static/heading-cnt.png) no-repeat 0 0; width: 983px; height: 161px;}
           ...
           #side-nav ul li .link {background: url(static/side-nav.png) no-repeat 0 0; width: 205px; height: 22px;}
           ...
           #heading-box-cnt {background: url(static/heading-box.png) no-repeat 0 0; width: 709px; height: 316px; padding-top: 5px; padding-left: 4px;}
           ...
           .featured-main-details-cnt { background: url(static/featured-main-details.png) repeat 0 0; width: 425px; height: 44px; padding-left: 10px; padding-top: 7px; padding-right: 5px;}
           ...
           #main {background: url(static/main-bg.gif) repeat-x 0 0; padding-top: 8px; padding-bottom: 45px;}
           ...
           #sidebar ul li {background: url(static/news-divider.gif) repeat-x 0 bottom; padding-bottom: 5px; padding-top: 5px;}
           ...
           #content {width: 1000px; float: ;}
           .grey-box {background: url(static/grey-box.gif) no-repeat 0 0; width: 209px; height: 228px; float: left; padding: 10px 26px 17px 8px;}
           ...
           a.button {background: url(static/button.png) no-repeat 0 0; float: right; width: 81px;height: 16px; display: block; color: #373737; font-size: 10px; padding-top: 3px; text-align: center; text-transform: uppercase;}
           
           .video-box {width: 690px; height: 191px; background: url(static/video-box.gif) no-repeat 0 0; padding-left: 10px; padding-top: 17px; padding-right: 13px;}
           .video-box h2 {padding-bottom: 10px !important;}
           .video-item-box {background: url(static/video-item-box.gif) no-repeat 0 0; width: 332px; height: 60px; float: left; padding-top: 8px; padding-left: 6px; padding-right: 17px; padding-bottom: 15px;}
           .video-item-box img {border: 3px solid #333; margin-right: 7px;}
           .video-item-box p {color: #f9f9f9;}
           .second {padding-right: 5px !important; background: url(static/second.gif) no-repeat 0 0; width: 324px; }
           ...
           #footer .shell {background: url(static/news-divider.gif) repeat-x 0 0; padding-top: 10px; margin: 0 auto;}
